 ...
 */
public class PageColumnSink
{
    private final ColumnarDataBuilder builder;
    private final PageColumnMover mover;

    public PageColumnSink(final ColumnarDataBuilder builder)
    {
        this.builder = requireNonNull(builder, "column builder is null");
        val vector = builder.getVector();
